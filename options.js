...
var customActionsNoValues = ["pause", "muted", "mark1", "mark2", "mark3", "mark4", "jump1", "jump2", "jump3", "jump4", "display"];
...
function add_shortcut() {
  var html = `<select class="customDo">
    ...
    <option value="mark1">Set marker1</option>
    <option value="mark2">Set marker2</option>
    <option value="mark3">Set marker3</option>
    <option value="mark4">Set marker4</option>
    <option value="jump1">Jump to marker1</option>
    <option value="jump2">Jump to marker2</option>
    <option value="jump3">Jump to marker3</option>
    <option value="jump4">Jump to marker4</option>
